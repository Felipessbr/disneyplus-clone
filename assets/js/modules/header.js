...
const openMenu = document.querySelector('[data-open-usermenu]');
...
function onWindowScroll(){
    ...
    function onTouchOpenNaveSubmenu(event){
...
function setListeners(){
    ...
    openNavSubmenu.addEventListener('touchstart',onTouchOpenNaveSubmenu);
    openMenu.addEventListener('touchstart',onTouchOpenUserMenu);
}
